# Generated manually to bootstrap the initial schema.
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="api.mltrainingjob",
                    ),
                ),
            ],
            options={"unique_together": {("model_id", "version")}},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "template",
                    models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name="campaigns", to="api.notificationtemplate"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(choices=[("final", "Final"), ("preliminary", "Preliminary"), ("amended", "Amended")], max_length=32),
                ),
                ...
                (
                    "patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="observations", to="api.patient"),
                ),
            ],
            options={"ordering": ["-effective_time"]},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="alert_configs", to="api.patient"),
                ),
            ],
            options={"unique_together": {("patient", "observation_code")}},
        ),
        migrations.CreateModel(
            name="Appointment",
            fields=[
                ...
                (
                    "status",
                    models.CharField(choices=[("booked", "Booked"), ("cancelled", "Cancelled"), ("completed", "Completed")], default="booked", max_length=32),
                ),
                ...
                (
                    "patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="appointments", to="api.patient"),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session",
                    models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name="metrics", to="api.telemedicinesession"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="consents", to="api.telemedicinesession"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "appointment",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="waitlist_entries", to="api.appointment"),
                ),
                (
                    "patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="waitlist", to="api.patient"),
                ),
            ],
            options={"unique_together": {("appointment", "patient")}},
        ),
        migrations.CreateModel(
            name="UserProfile",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="role_assignments", to="api.role"),
                ),
                (
                    "user",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="role_assignments", to=settings.AUTH_USER_MODEL),
                ),
            ],
            options={"ordering": ["-effective_date"], "unique_together": {("user", "role", "effective_date")}},
        ),
        migrations.CreateModel(
            name="PatientExport",
            fields=[
                ...
                (
                    "patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="exports", to="api.patient"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source_patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="merge_sources", to="api.patient"),
                ),
                (
                    "target_patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="merge_targets", to="api.patient"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="risk_scores", to="api.patient"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="alerts",
                        to="api.mlmodelversion",
                    ),
                ),
                (
                    "patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="personalized_alerts", to="api.patient"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["practitioner_reference", "start"], name="api_appoint_practit_1f647c_idx"),
        ),
    ]
